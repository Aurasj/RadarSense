...
if (UI_DEBUG) console.log("[AntRadar] main.js loading...");
...
// INITIALIZATION
function init() {
  if (UI_DEBUG) console.log("[AntRadar] Initializing DOM and Socket...");
  try {
    elements = {
      connLed:           $("connLed"),
      connText:          $("connText"),
    ...
    if (UI_DEBUG) console.log("[AntRadar] Initialization complete.");
